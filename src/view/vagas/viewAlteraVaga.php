<div class="container">
    <div class="row">
        <form id="cadastro-usuario" class="col s12 m8 l8 offset-m2 offset-l2 hoverable z-depth-5 alinhar-view" action=""
            method="post">
            <h3 class="light center-align">Alterar Vaga</h3>
            <div class="row">
            ...
            <button class="btn btn-form waves-effect waves-light green darken-3" type="submit" name="alterar-vaga">Alterar</button>
        </form>
    </div>
</div>
